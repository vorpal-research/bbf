...
@Suppress("DEPRECATION_ERROR") class MyUIntArray(private val storage: IntArray) : Collection<MyUInt> {
...
fun <T> checkBoxed(c: String?, element: Set<Map<Pair<ArrayList<String>,Map<Pair<String,Float>,HashMap<ArrayList<*>,Long>>>,String>>): Boolean = true
...
fun <T> checkBoxed(c: Collection<(StringBuilder)>, element: T): Boolean {
